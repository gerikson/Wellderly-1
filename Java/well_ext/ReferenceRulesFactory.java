...
public class ReferenceRulesFactory extends ScalarFunctionFactory {
	...
	public void getReturnType(ServerInterface srvInterface,
		...
		outputTypes.addVarchar(25, // inputTypes.getColumnType(1).getStringLength(),
				"Reference");
	}
	...
	public class ReferenceRules extends ScalarFunction {
