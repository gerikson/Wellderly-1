...
haplotype,
  ...
  reactome_pathway,
  gene_onotology)
from local '/home/dbadmin/SUMMARY_masterVarBeta-GS000014945-ASM_novel_annotation.txt';

COPY staging.sg_advisor from '/home/dbadmin/SUMMARY_masterVarBeta-GS000014945-ASM_novel_annotation.txt' with trailing nullcols delimiter E'\t';

COPY test_flex  from '/home/dbadmin/SUMMARY_masterVarBeta-GS000014945-ASM_novel_annotation.txt' parser fdelimitedparser(delimiter='\t');
