from variant_quality import variants_qual_report

def create_page(af, vq):
    
    nr = variants_qual_report()
    my_content = nr.get_records(af, vq)
    ...
    my_page = my_page + "<h>\n"
    my_page = my_page + "<title>Variants by Variant Quality Query</title>\n"
    my_page = my_page + "<body>\n<hr>\n<img src='stsi_logo.jpg'><br>\n<h1>Variants within Allele Frequency</h1>\n<h2>Allele Frequency: "+ str(af) +" Variant Quality: "+ vq + "</h2><br>\n<table>\n"
    my_page = my_page + "<tr><th>Patient ID</th><th>Gene Ontology ID</th><th>Gene</th><th>Chromosome</th><th>Allele Variant</th><th>Reference</th><th>Begin</th><th>End</th><th>Variant Quality<th>Genome AF</th><th>Wellderly AF</th></tr>\n"
