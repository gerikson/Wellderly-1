from NIF_request import nif_report

def create_page(self):   
    
    nr = nif_report()
    my_content = nr.get_nif_recs('aging')
    ...
    my_page = my_page + "<h>\n"
    my_page = my_page + "<title>Ontology Base Query</title>\n"
    my_page = my_page + "<body>\n<hr>\n<img src='stsi_logo.jpg'><br>\n<h1>Query by Ontology</h1>\n<h2>Ontology Keyword: aging</h2><br>\n<table>\n"
